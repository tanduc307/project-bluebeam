...
• It can be a single leaf, a whole plant, an area of ground containing many plants, a pot or a flat in the green house, a single animal, several animal, or an entire herd [@little1978].

• The term *plot* is synonymous with experimental unit and is frequently used in referring to plant experimental units. "Plot" is sometimes incorrectly used in referring to an entire experiment that really consists of several plots.
