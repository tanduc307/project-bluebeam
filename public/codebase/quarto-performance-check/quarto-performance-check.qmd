...
**Trong phạm vi bài hướng dẫn này ta tập trung vào các lệnh kiểm tra tổng quát hiệu năng máy tính khi sử dụng R, đây là cơ sở giúp ta đánh giá tốc độ xử lý của R trong các tình huống cụ thể sau này. Các lệnh này được mình test trên máy tính để bàn sử dụng hệ điều hành windows.**
