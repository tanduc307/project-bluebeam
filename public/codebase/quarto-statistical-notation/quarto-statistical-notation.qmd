...
<table class="table table-striped table-bordered table-hover table-sm">
  ...
  <tbody class="text-center align-middle">
    <tr>
      ...
      <br>• Hoặc là **chi-square** (không có ed và có gạch nối) [@le2016, p. 470]</td>
    </tr>
      <tr>
      <th>2</th>
      ...
      <br> • Student's ***t* test** (chữ t in nghiêng, không có gạch nối)[^6]
      <br> Về mặt thuật ngữ, *t*-test là kiểm định *t*, với *t* là một chỉ số thống kê. Ta có *t*-distribution hay t distribution. Rất ít tài liệu viết hoa chữ T. 
      <br>Mình chọn cách viết chữ t trong chữ *t*-test là viết in nghiêng, có gạch nối.</td>
    </tr>
  </tbody>
</table>
