# **Bài 13: Hướng dẫn phân tích t-test trong R** {.unnumbered}
...
<span style="background-color:dodgerblue; text-align:center;color:white;font-size:24px;">**Từ chỗ này trở đi ta sẽ tính riêng cho chỉ tiêu "LBL" cho "Flower A" và "Flower B". Các chỉ tiêu còn lại thực hiện tương tự.**</span>
...
**Giả thuyết cho t-test 2 samples** 
...
**p-value lớn hơn 0.05 nên bác bỏ H1 chấp nhận H0, tức là phương sai của hai biến này không khác biệt nhau.**
...
#### <span style="color:blue">**Bước 4:Kiểm tra giả thuyết cho t-test cho cùng lúc nhiều cột**</span>
