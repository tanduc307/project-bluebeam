# **Bài 14: Phân tích ANOVA 2 yếu tố trong R** {.unnumbered}

```{r, include=FALSE}
knitr::opts_chunk$set(fig.width = 8, fig.height = 4, warning = FALSE, message = FALSE)
```

## Phân tích ANOVA 2 yếu tố trong R
...
1. `https://thongkesinhhoc.quarto.pub/phan-tich-anova-2-yeu-to-kieu-rcbd-trong-r.html`
